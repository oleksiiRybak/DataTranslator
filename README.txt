...
---------------------------------------Data Translator ----------------------------------------------
The application traverses different columns and rows to different custom names

- due to time limitation I've applied only one test but normally I'd thoroughly cover the solution with tests 
